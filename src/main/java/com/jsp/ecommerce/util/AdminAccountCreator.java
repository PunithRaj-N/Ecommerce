...
//public class AdminAccountCreator implements CommandLineRunner { //once server it automatically runs
//
...
//	
//	@Override
//	public void run(String... args) throws Exception { //it automatically called
//		log.info(adminEmail);
